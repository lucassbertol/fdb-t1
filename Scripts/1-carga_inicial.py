"""
Etapa 4 – Carga 1: Extrator CSV → Tabela Desnormalizada (MySQL)
================================================================
Uso:
    pip install mysql-connector-python pandas
    python etapa4_extrator.py

Ajuste as variáveis de configuração abaixo antes de executar.
"""
...
CSV_FILE    = "games.csv"          # caminho para o arquivo CSV
ENCODING    = "utf-8"              # troque por "latin-1" se necessário
BATCH_SIZE  = 50                   # linhas por INSERT em lote
# ─────────────────────────────────────────────
...
def load_csv_to_db():
    ...
    # Limpa tabela antes de recarregar (opcional – comente se não quiser)
